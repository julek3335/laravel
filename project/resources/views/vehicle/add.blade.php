        ...
        <div class="row">
            ...
            <x-adminlte-input name="name" type="text" label="Nazwa" placeholder="Nazwa" disable-feedback/>
                ...
                <x-adminlte-input name="max_axle_load" type="number" label="Maksymalne obciążanie osi (KG)" placeholder="1400"
                    disable-feedback/>
                <x-adminlte-input name="max_towed_load" type="number" label="Maksymalne ciężar holowania (KG)" placeholder="1600"
                    disable-feedback/>
                <x-adminlte-input name="max_total_weight" type="number" label="Maksymalny ciężar całkowity" placeholder="1600"
                    disable-feedback/>
